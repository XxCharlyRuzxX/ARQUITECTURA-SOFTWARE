...
import proyecto1.MessageParticipants;
...
public class Renderizador {
    ...
    public String[] prepararTextos(String contenido, ArrayList<MessageParticipants> participantes){
    ...
    public String[] reemplazarTextos(String[] textos, ArrayList<MessageParticipants> participantes){
